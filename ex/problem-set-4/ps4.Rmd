...
```{r q2, eval = FALSE, fig.width = 6, fig.height = 3.5}
...
```{r q3, eval = FALSE, fig.width = 6, fig.height = 3.5}
plot_expr <- function(input, sys_name, nutri, add_lm = FALSE) {
  # Finish writing the function
...
```{r q4, eval = FALSE, fig.width = 6, fig.height = 3.5}
plot_expr <- function(input, sys_name, nutri, add_lm = FALSE) {
  # Finish writing the function
...
```{r q5, eval = FALSE, fig.width = 10, fig.height = 6.5}

sys_names <- c("YNL049C", "YML017W", "YDL104C", "YLR115W")

expr_plots <- lapply(
  # Add the arguments for lapply()
