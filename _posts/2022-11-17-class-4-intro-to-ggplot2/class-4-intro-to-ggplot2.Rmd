...
It's an alternative to the built in R graphics and plotting functions.  
...
geom_jitter(): jittered point plot
...
Take some time to play around with this template. Try substituting different columns from the dataframe and applying additional aesthetics.  
...
Try out these other aesthetic options: `shape` and `alpha`
Q: How can they be used to enhance your plots?
