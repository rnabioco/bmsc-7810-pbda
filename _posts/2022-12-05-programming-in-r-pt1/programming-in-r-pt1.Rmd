...
source("https://raw.githubusercontent.com/rnabioco/bmsc-7810-pbda/main/_posts/2022-12-05-programming-in-r-pt1/download_files.R")
```
...
```{r}
gene_exp <- read_csv("data/brauer_gene_expression.csv")
```
