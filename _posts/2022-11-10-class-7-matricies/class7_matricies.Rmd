...
*The Rmarkdown for this class is [on github](https://raw.githubusercontent.com/rnabioco/bmsc-7810-pbda/class_7-9/_posts/2022-11-10-class-7-matricies/class7_matricies.Rmd)*
...
# it in the same directory as this script for simplicity
...
names_dat <- pivot_longer(names_dat, cols = pivot_columns,
...
names_dat <- names_mat %>% 
  ...
  pivot_longer(cols = pivot_columns, 
               names_to = "state", values_to = "count")
```
