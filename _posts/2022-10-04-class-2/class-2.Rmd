...
```{r, eval = FALSE}
library(stringr)
some_words <- c("a sentance", "with a ", "needle in a", "haystack")
...
str_subset(complex_strings, "[0-9]+-") # keep words with a series of #s followed by a dash, + indicates one or more occurrences.
str_subset(complex_strings, "-[0-9]+") # keep words with a dash followed by a series of #s
...
Use dplyr filter and stringr functions to do something...
```{r}
